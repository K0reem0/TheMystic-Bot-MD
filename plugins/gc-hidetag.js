...
**/
    ...
    const htextos = `${text ? text : '*منشن :D*'}`;
    if ((isMedia && quoted.mtype === 'imageMessage') && htextos) {
      ...
      await conn.relayMessage(m.chat, {extendedTextMessage: {text: `${masss}\n${htextos}\n`, ...{contextInfo: {mentionedJid: users, externalAdReply: {thumbnail: imagen1, sourceUrl: 'https://whatsapp.com/channel/0029Vak3oVNISTkBhE5ypj43'}}}}}, {});
    }
  }
};
handler.command = /^(مخفي|منشن|notify)$/i;
handler.group = true;
handler.admin = true;
